...
| `skills-sync.py` | executor | propagates skills from the manifest to every machine, with noninteractive Git clones and a bounded timeout for third-party sources |
